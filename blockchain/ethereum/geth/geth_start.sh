...
3. Run the following cmd to import priv-key: `geth --testnet account import --datadir /home/huyanyan/ethereum/ropsten/datadir/ priv`
4. You should see the new account immediately in geth console by typing web3.eth.accounts

# Extra step to configure coinbase
